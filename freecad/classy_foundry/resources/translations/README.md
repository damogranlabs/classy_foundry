# About translating classy_foundry

> [!NOTE]
> All commands **must** be run in `./freecad/classy_foundry/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **classy_foundry** project.

## Creating file for missing locale

To create a file for a new language with all **classy_foundry** translatable strings execute
...
once done, look for the **classy_foundry** project.
...
Now you can contribute your translated `.ts` file to **classy_foundry** repository,
also include the `.qm` file.

<https://github.com/damogranlabs/classy_foundry>
